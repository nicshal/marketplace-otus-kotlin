...
import ru.nicshal.tariff.management.biz.TrmngTariffProcessor
...
interface ConsumerStrategy {
    ...
    fun serialize(source: TrmngContext): String
    fun deserialize(value: String, target: TrmngContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: TrmngTariffProcessor = TrmngTariffProcessor(),
    ...
    private fun sendResponse(context: TrmngContext, strategy: ConsumerStrategy, outputTopic: String) {
